		...
		<div class="widgets-wrapper">
			...
			<div class="widget">
				...
				<ul class="socials">
					<?php if ( $socials_fb ) : ?>
						<li>
							<a href="<?php echo esc_url( $socials_fb ); ?>" aria-label="Find us on Facebook">
					...
					if ( $socials_in ) :
						?>
						<li>
							<a href="<?php echo esc_url( $socials_in ); ?>" aria-label="Find us on Instagram">
								<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
					...
					if ( $socials_link ) :
						?>
						<li>
							<a href="<?php echo esc_url( $socials_link ); ?>" aria-label="Find us on LinkedIn">
								<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
					...
					if ( $socials_yt ) :
						?>
						<li>
							<a href="<?php echo esc_url( $socials_yt ); ?>" aria-label="Find us on YouTube">
								<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
